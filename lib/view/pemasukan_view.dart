      ...
      body: Column(
        children: [
          ...
          DateRangeFilter(
            ...
            onFilter: (start, end) {
              context.read<PemasukanViewModel>().applyFilter(start, end);
            },
            onReset: () {
              context.read<PemasukanViewModel>().clearFilter();
            },
          ),
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              vm.isFiltered
                  ? 'Tidak ada data pemasukan pada rentang tanggal ini'
...
class _PemasukanCardState extends State<_PemasukanCard> {
  ...
  @override
  Widget build(BuildContext context) {
    // Saldo sistem real-time = total pemasukan record ini
    final saldoSistem = widget.item.totalPemasukan;
